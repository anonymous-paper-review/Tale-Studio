...
## 관련 문서 (이 세션 산출)
- `research/records/2026-07-21-structure-form-vs-scale-axes.md` — (후속 토론) 구조유형=형태 vs 깊이레벨=규모 축 분석, 사다리 결함 3개, 수정 방향 + 프로브 2셀.
- `research/canon/writer-job-model.md` — (후속) writer 직무 모델 + 프롬프트 독트린 P1~P6 (원장/물리/관습 3진실).
- `research/records/2026-07-21-writer-prompt-audit.md` — (후속) 12개 스테이지 시스템프롬프트 전수 감사 — 전역 결함 5 + 스테이지별 피드백 + 실험 백로그 E1~E13.
- `research/experiments/utils/campaign-2607/plan.md` — (후속) 감사 백로그의 실행 계획 승격 — W그룹(청소)/E그룹(A/B) 구분, Phase 1~4, 결과는 `experiments/results/`.
