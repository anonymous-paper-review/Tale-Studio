...
- **전제**: 배선은 살아 있고 푸시됐다(`src/app/layout.tsx:46`, `src/middleware.ts:131·134`, 커밋 `1040fd3`, main↔origin 동기, main 자동배포) — 스위프에서 대조 확인. matcher 제외 문자열이 `_vercel/`로 들어간 것도 확인. **실제 응답만 미확인.**
