...
blockers: []
status: 대체됨  # 2026-08-11 t2-contract-generalize로 통합 — 변인을 '참조 역할 계약 유무'로 좁혀 3시나리오 6클립으로 재설계(원 설계는 3암×3세트=$32). 원 관심사(스토리별·움직임별·연출별)는 그 티켓의 S1·S2·S3가 승계 — 지시 원문이 승인 근거
priority: high
```
