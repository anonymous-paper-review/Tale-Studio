...
## 5. v2 보강 (2026-07-23 — 전 팔 공통 텍스트 계약)

SNS 실물 분석(해석: `../../../references/2026-07-23-sns-seedance-method.md`) 반영으로, 모든 팔의
영상 프롬프트에 3층 텍스트 계약이 공통 추가된다: ① 연속성 바이블(의상 LOCKED·빛 방향·180° 라인)
② 드리프트 네거티브 배터리(의상 플리커·그림자 뒤집힘·낮밤 점프·다중 얼굴·플라스틱 피부 금지)
③ 샷별 결말 상태 명문화. 팔 간 차이는 여전히 "이미지를 어떻게 주느냐"뿐 — 이 계약은 통제 변수다.
