...
blockers: []
status: done  # 2026-08-12 밤 러너 — 가설 유지(위반 2씬/2런, 서로 다른 프로젝트·날짜). 기각 조건 미발동. 2건 중 1건은 done 런에서 조용히 데이터 유실(key_dialouge 오타). 결과: research/experiments/t0-scene-schema-typo-prevalence/
priority: high
```
