...
- [x] A — **완료 (A1·A2·A3 전부 닫힘)**. A3 트림·컷 영속화 수리. A2 Writer 93% 붙잡힘 + Director 영상 stage-away 재현·수리·배포 검증. A1 "재생성 불가" — 좀비 queued 잡이 force 재생성을 영구 차단하던 사슬(가드 순서·회수 실패·클라 무음) 수리. **한도 정책 확정** — 영상 3 / 이미지 6 분리 풀 + admin 면제.
- [ ] B
- [ ] C
- [ ] D
- [ ] E
