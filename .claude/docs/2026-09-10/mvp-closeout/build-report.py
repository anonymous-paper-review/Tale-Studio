...
<div class="callout"><strong>main 제품: {commit} · 운영: {escape(state)}</strong><br>자동검사 {passed:,}개 통과 · 실패 {failed}개 · 기존 제외 {skipped}개. 타입·디자인·lint·빌드 결과는 아래 검증 기록을 따릅니다.</div>
...
<p><strong>운영 배포 READY · <a href="https://github.com/anonymous-paper-review/Tale-Studio/actions/runs/34445947729">GitHub CI 성공</a>.</strong> 운영 첫 화면 HTTP 200과 로그인 전 Artist 접근의 정상 로그인 이동을 확인했습니다. 기능 시나리오는 위에 표시한 개발 표본에서 검증했습니다.</p>
