...
//   사라지고 시간 약 25% 절감이 관측됐다(research/experiments/stage-merge/2026-07-21_merge-approx/result.md).
//
...
export async function runStructureScenesMerged(
  ...
  // #p4-websearch · #p4-json-guard(2026-08-12): MergedRawSchema(⊃ScenesSchema) 가 StoryScene
